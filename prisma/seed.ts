...
async function main() {
  // Explicitly tell TS this is input, not the DB type
  const brands: Prisma.BrandCreateInput[] = [
    { alias: "cerave", title: "CeraVe" },
    { alias: "theordinary", title: "The Ordinary" },
    { alias: "skinceuticals", title: "SkinCeuticals" },
    { alias: "paulaschoice", title: "Paula's Choice" },
    { alias: "larocheposay", title: "La Roche-Posay" },
    { alias: "cosrx", title: "COSRX" },
    { alias: "innisfree", title: "Innisfree" },
    { alias: "drunk-elephant", title: "Drunk Elephant" },
    { alias: "tatcha", title: "Tatcha" },
    { alias: "skin1004", title: "SKIN1004" },
    { alias: "laneige", title: "Laneige" },
    { alias: "glowrecipe", title: "Glow Recipe" },
    { alias: "kiehls", title: "Kiehl’s" },
    { alias: "bioderma", title: "Bioderma" },
    { alias: "firstaidbeauty", title: "First Aid Beauty" },
    { alias: "isntree", title: "Isntree" },
    { alias: "neutrogena", title: "Neutrogena" },
    { alias: "shiseido", title: "Shiseido" },
    { alias: "missha", title: "Missha" },
    { alias: "sulwhasoo", title: "Sulwhasoo" },
  ];
  ...
  console.log("Skincare brands seeded successfully!");
}
