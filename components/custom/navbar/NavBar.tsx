  ...
  return (
    <div className="sticky top-0 ">
      <div className="relative ">
        ...
        <div className=" bg-gray-50 py-9 z-[2000] h-3 flex">
          <div className="max-w-7xl container mx-auto flex items-center justify-between px-6 sm:px-12 ">
            <h1
            ...
            <ul className=" hidden lg:flex items-center justify-center space-x-8 w-full ">
              {menus.map((navbar) => (
                <li key={navbar.id} className=" group ">
                  ...
                  {navbar.hasHover && (
                    <div
                      className={`absolute mt-2 top-12  dark:bg-gray-800 shadow-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50   py-4 px-2 mx-auto container ${
                        navbar.id === 1
                          ? "left-0 right-0 w-[1000px]"
                          : " max-w-md"
                      }`}
                    >
            ...
            <div className="md:w-2/12 justify-end flex items-center ">
              <div className="hidden lg:flex items-center ">
                ...
                <Link
                  href={"/login"}
                  className="dark:text-white  focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"
                >
